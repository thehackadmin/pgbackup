...
--
-- Name: employees; Type: TABLE; Schema: public; Owner: dbroot
--
...
ALTER TABLE public.employees OWNER TO dbroot;

--
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: dbroot
--
